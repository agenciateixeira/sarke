-- =====================================================
-- INSTRUÇÕES: Copie TODO este arquivo e execute no Supabase Dashboard
-- Caminho: https://supabase.com/dashboard → SQL Editor → New Query
-- =====================================================

-- 1. Remove função antiga (se existir)
DROP FUNCTION IF EXISTS arquivar_obra_no_memorial(UUID, UUID, TEXT);

-- 2. Cria função corrigida
...
BEGIN
  ...
  -- 5. Mover RDOs (CORRIGIDO: usando colunas corretas)
  ...
  -- 6. Mover caixa de obra (CORRIGIDO: usando tabela e colunas corretas)
  ...
  -- 7. Mover orçamento de materiais (CORRIGIDO: nome correto da tabela)
  ...
  -- 8. Registrar empresas parceiras (CORRIGIDO: tabela e colunas corretas)
...
-- =====================================================
-- TESTE (OPCIONAL): Verificar se a função foi criada
-- =====================================================
-- SELECT routine_name
