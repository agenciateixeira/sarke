-- =====================================================
-- ATUALIZAÇÃO: Adicionar categoria no INSERT de obra_caixa
-- Execute SOMENTE este SQL (rápido, não recria toda função)
-- =====================================================
...
BEGIN
  ...
  -- 6. Mover caixa de obra (COM CATEGORIA AGORA)
