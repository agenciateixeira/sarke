...
export default function ProjetosCorporativosPage() {
      ...
      <div className="flex flex-col gap-6 p-6">
        <div className="flex items-center justify-between">
          <PageHeader
            ...
            description="Projetos da área corporativa"
          />
          <Button asChild>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Projetos corporativos</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="py-12">
              <div className="text-center text-muted-foreground">
                <Factory className="h-12 w-12 mx-auto mb-4 opacity-50 animate-pulse" />
            ...
            <CardContent className="py-12">
              <div className="text-center text-muted-foreground">
                ...
                <p className="text-lg font-semibold mb-2">
                  {searchTerm ? 'Nenhum projeto encontrado' : 'Nenhum projeto corporativo cadastrado'}
                </p>
                <p className="text-sm mb-4">
                  {searchTerm ? 'Tente ajustar o termo de busca' : 'Crie seu primeiro projeto corporativo'}
                </p>
              </div>
            </CardContent>
          </Card>
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-start gap-2 flex-1 min-w-0">
                        <Factory className="h-5 w-5 mt-0.5 flex-shrink-0 text-muted-foreground" />
