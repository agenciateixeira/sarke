  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const empresaData = {
        ...
        observacoes_gerais: formData.observacoes || null,
      ...
      router.push(`/dashboard/obra/empresas/${params.id}`)
    } catch (error: any) {
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href={`/dashboard/obra/empresas/${params.id}`}>
              <ArrowLeft className="h-5 w-5" />
            </Link>
          </Button>
          <div>
            <h1 className="text-3xl font-bold">Editar Empresa Parceira</h1>
          ...
          <div className="grid gap-6">
            ...
            <div className="flex justify-end gap-3">
              <Button type="button" variant="outline" asChild>
                <Link href={`/dashboard/obra/empresas/${params.id}`}>Cancelar</Link>
              </Button>
